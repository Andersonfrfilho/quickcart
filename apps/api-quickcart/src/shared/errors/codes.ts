...
export const ORDER_CUSTOMER_APPROVAL_REQUIRED = 'ORDER_CUSTOMER_APPROVAL_REQUIRED'
export const ORDER_ITEM_NOT_SUBSTITUTABLE = 'ORDER_ITEM_NOT_SUBSTITUTABLE'
...
export const CUSTOMER_PHONE_ALREADY_REGISTERED = 'CUSTOMER_PHONE_ALREADY_REGISTERED'
